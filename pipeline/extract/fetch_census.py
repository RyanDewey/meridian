...
population_base_url = 'https://api.census.gov/data/2023/acs/acs5?get=NAME,B01001_001E&for=zip%20code%20tabulation%20area:'
...
def get_population_data(zip_codes):
    ...
    print(f"{population_base_url}{zip_codes_list}&key={api_key}")
